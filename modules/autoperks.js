...
queuescript.src = 'http://likexia.gitee.io/autotrimps/FastPriorityQueue.js';
...
AutoPerks.VariablePerk = function(name, base, compounding, value, baseIncrease, max, level) {
    ...
    function getRatiosFromPresets() {
        ...
        var valueArray = [];
        for (var i=0; i<AutoPerks.presetList.length; i++) {
            valueArray.push(AutoPerks.presetList[i][value]);
        }
        return valueArray;
...
var capable = new AutoPerks.FixedPerk("capable", 100000000, 10, undefined, true);
...
AutoPerks.presetList = [preset_ZXV,preset_ZXVnew,preset_ZXV3,preset_TruthEarly,preset_TruthLate,preset_nsheetz,preset_nsheetzNew,preset_HiderHehr,preset_HiderBalance,preset_HiderMore,preset_genBTC,preset_genBTC2,preset_Zek450];
//gather these into an array of objects
